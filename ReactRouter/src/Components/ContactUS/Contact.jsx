...
export default function Contact() {
    return (
        <div className="relative flex items-top justify-center min-h-[700px] bg-white sm:items-center sm:pt-0 px-4">
                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <form className="p-6 bg-white rounded-lg shadow-md">
                            ...
                            <button
                                type="submit"
                                className="bg-orange-700 text-white font-semibold py-3 px-6 rounded-lg hover:bg-orange-800 transition duration-300"
                            >
                                Submit
                            </button>
                        </form>
